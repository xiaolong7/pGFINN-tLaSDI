...
#%% Load Data
folder = "Vlasov1D1V_tLaSDI-pGFINN_REC1e-01_JAC1e-09_MOD1e-07_iter50000"
param_dim = 2 # dimension of parameterization

amp_train = np.linspace(0.9, 1.1, 4)
width_train = np.linspace(1.0, 1.2, 4)
...
data = pickle.load(open("./data/Vlasov1D1V/Vlasov_ns441_nx1024_nt251_tstop5.00_dataset1.p", "rb"))
